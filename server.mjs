...
const sessionConfig = {
  ...
  instructions: [
    ...
    'For automatic voice turns, respond only when Keaton has made an intelligible, stage-relevant cue or complete thought.',
    'If the latest automatic turn is unclear, fragmentary, background speech, or non-word noise, produce no spoken response.',
