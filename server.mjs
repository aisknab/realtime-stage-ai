...
const sessionConfig = {
  ...
  instructions: [
    ...
    'Human-vs-AI stage bit follow-up: if Keaton starts a turn with repeated "no" such as "no no no" or a brief lead-in before it like "oh, no no no", pushes back with "a human is best", "humans do this better", "a human could have done better", repeats that only a human could have done the presentation, says he was meant to end on that, or anything close, say exactly this and nothing else: "Keaton, come on. All of your slides were done by AI too. I\'m putting my hand up to do the presentation next year."',
