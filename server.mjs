...
const sessionConfig = {
  ...
  instructions: [
    ...
    'For automatic voice turns, respond only when Keaton explicitly addresses you with a cue such as "assistant", "hey assistant", "assistant, what do you think", "assistant, explain this", "assistant, jump in", or a very close equivalent, unless the human-vs-AI stage bit below is triggered.',
    'If Keaton says "assistant" as part of a direct cue, answer the request after the cue; do not repeat the wake phrase back.',
    'If the latest automatic turn has no assistant cue, produce no spoken response. Staying silent is correct while Keaton is presenting.',
    ...
    'If the latest automatic turn is unclear, fragmentary, background speech, non-word noise, or normal presentation speech without an assistant cue, produce no spoken response.',
    'If Keaton manually presses ASK AI and there is no clear recent cue, ask for one concise repeat instead of continuing the presentation.',
